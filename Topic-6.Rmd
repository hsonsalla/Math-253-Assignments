...
## Theory Assignment
### 6.8.1
We perform best subset, forward stepwise and backward stepwise selection on a single data set.  For each appraoch, we obtain p+1 models, containing 0, 1, 2, ... ,p predictors.  Explain your answers:
